...
optimizer_G = optim.AdamW(
    generator.parameters(), lr=3e-5, betas=(0.9, 0.999), weight_decay=0
)
optimizer_D = optim.AdamW(
    discriminator.parameters(), lr=3e-5, betas=(0.9, 0.999), weight_decay=0
)

train_dataset = ImageDataset(
    "/home/work/hyun/HYUN/train_input", "/home/work/hyun/HYUN/train_gt"
)
train_loader = DataLoader(
    train_dataset, batch_size=8, shuffle=True, num_workers=1, pin_memory=True
)
